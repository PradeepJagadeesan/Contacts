...
const renderContacts = (data,id) => {
    ...
    <div href="#!" class="secondary-content" data-id=${id} style="text-align:right;">
      ...
      <i class="material-icons" style="cursor:pointer">${data.favourite ?'star':'star_border'}</i>
...
const updateContact=(data,id)=>{
  ...
  contact.querySelectorAll('.material-icons')[1].textContent=data.favourite?'star':'star_border';
}